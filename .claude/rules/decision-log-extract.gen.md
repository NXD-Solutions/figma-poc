...
<!-- AUTO-GENERATED — do not edit by hand.
     Regenerated by the 'Sync decisions from Confluence' GitHub Actions workflow. -->
...
**Usage of GitHub PATs for NXD tooling** — Accepted
- If a GitHub token isn't working, tell the user to read the token setup instructions at: Classic PATs for NXD tooling

**React and Vite adopted as frontend framework** — Accepted
- All frontend applications must use React with Vite — no alternative frameworks.
- TypeScript is the expected language alongside React.

**Feature branches required for all code changes** — Accepted
...
**Vitest and React Testing Library adopted as the front-end test stack** — Accepted
...
**Figma adopted as the UI design tool** — Accepted
...
**React + Vite adopted for front-end development** — Accepted
...
**Tailwind CSS adopted as the styling framework for FE Dev** — Accepted
...
**PostgreSQL adopted as standard relational database** — Draft
...
**Microservices architecture adopted** — Accepted
...
**OpenAI-compatible API standard adopted for all model integrations** — Accepted
...
**Kubernetes chosen as sole deployment platform** — Accepted
...
**mTLS enforced for all inter-service communication** — Accepted
...
**Per-tenant branding supported as a platform capability** — Accepted
...
**All persistent data must be encrypted at rest** — Proposed
...
**Platform scales horizontally without limit** — Accepted
...
**Customers own their prompts and outputs** — Accepted
...
**All EU customer data must remain within EU boundaries** — Accepted
...
**No vendor lock-in permitted** — Accepted
